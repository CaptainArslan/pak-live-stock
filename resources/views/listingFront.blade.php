@extends('layouts.app')
@section('title', 'Livestock - Pak Livestock')
@section('content')
<!-- Product Cards Grid -->
<div class="container px-lg-5 mt-md-5">
    ...
    <div class="swiper categorySwiper">
        <div class="swiper-wrapper start-dir">
            @foreach($categories as $category)
                @if (!$mainCat || $category->main_cat == $mainCat)
                    <a href="/listingFront?category={{ $category->id }}"
                       class="d-flex justify-content-between px-lg-4 swiper-slide card-slider text-dark card position-relative"
    ...
    <div class="container my-5 px-lg-5">
        <form method="GET" action="{{ url('/listingFront') }}" class="row g-3 mb-4 justify-content-center">
