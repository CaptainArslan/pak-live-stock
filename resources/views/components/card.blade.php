...
<div class="container my-5 px-lg-5">
  ...
  <div class="d-flex justify-content-between">
      <div class="pe-1 swiper-button-prev-{{ $index }} d-flex justify-content-center align-items-center text-center">
    ...
    <div class="ps-1 swiper-button-next-{{ $index }} d-flex justify-content-center align-items-center text-center">
