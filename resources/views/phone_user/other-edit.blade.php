                ...
                <div class="step card shadow-lg p-4 mb-4 border-0 rounded-4" data-step="1" style="display:block;">
                    ...
                    <div class="row g-3">
                        ...
                        <div id="Title" class="col-md-6 col-sm-12">
                            ...
                            <input type="text" id="title" name="title" value="{{$listing->title}}" class="form-control" placeholder="عنوان درج کریں" required>
                        </div>
                        
                        <div id="quantityForsheep" class="col-md-6 col-sm-12">
                            <label class="form-label">تعداد<span class="text-danger">*</span></label>
                            <input type="number" id="quantity" name="quantity" value="{{ old('quantity', $listing->quantity ?? '') }}" class="form-control" min="1" placeholder="تعداد درج کریں" required>
                        </div>
                        
                        <div id="singlePrice" class="col-12 col-md-6 col-lg-6">
                            <label class="form-label d-block mb-2">قیمت منتخب کریں
                                <span class="text-danger">*</span></label>
                            <input type="number" name="price" value="{{$listing->price}}" class="form-control" placeholder=" قیمت" required>
                        </div>
